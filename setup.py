...
setup(name='docassemble.assignment2020t1brendakhoo',
      version='0.0.1',
      ...
      author='Brenda Khoo',
      author_email='brenda.khoo.2017@law.smu.edu.sg',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/assignment2020t1brendakhoo/', package='docassemble.assignment2020t1brendakhoo'),
     )
